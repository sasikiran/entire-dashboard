...
@Data
@Schema(description = "Repository Update Request Parameters")
public class RepoUpdateParams {
    @NotNull(message = "Repository ID cannot be empty")
    @Schema(description = "Repository ID", requiredMode = Schema.RequiredMode.REQUIRED, example = "1")
    private Long id;
